...
park/POI match cache is complete at activation.
...
- Run the PostGIS integration suite; it proves inclusive 500 m and exclusive 501 m
  behavior after the broad cache.
...
retryable 503. Searches with food set to “any” remain independent of this corpus.
